...
if ((std::abs((sprite_Mario.getPosition().x + 17) - (sprite_cesse.getPosition().x + 17)) < 34) &&
(std::abs((sprite_Mario.getPosition().y + 17) - (sprite_cesse.getPosition().y + 17)) < 34))
{
	if (rotation == 1) {
		sprite_cesse.move(0, vitesseMario);
	}
	else if (rotation == 2) {
		sprite_cesse.move(0, -vitesseMario);
	}
	else if (rotation == 3) {
		sprite_cesse.move(vitesseMario, 0);
	}
	else if (rotation == 4) {
		sprite_cesse.move(-vitesseMario, 0);
	}
